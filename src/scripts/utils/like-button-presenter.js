import {createLikeMovieTemplate, createUnlikeMovieButtonTemplate } from '../views/templates/template-creator'
const LikeButtonPresenter = {
  ...
  _renderLike() {
    this._likeButtonContainer.innerHTML = createLikeMovieTemplate();
